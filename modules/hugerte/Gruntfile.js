...
module.exports = function (grunt) {
  ...
  grunt.initConfig({
    ...
    copy: {
      ...
      'default-icons': {
        options: {
          // The icon pack is generated by the oxide tools for TinyMCE and registers itself on the
          // `tinymce` global, which does not exist in HugeRTE: the standalone icon files would
          // throw before adding a single icon.
          process: (content) => content.replace(/\btinymce\.IconManager\b/g, 'hugerte.IconManager')
        },
        files: [
          {
            expand: true,
